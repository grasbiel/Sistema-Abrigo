# Generated by Django 5.2.5 on 2025-08-08 02:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_validade', models.DateField(blank=True, help_text='Apenas para itens da farmácia.', null=True)),
                ...
                ('departamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='produtos', to='core.departamento')),
            ],
        ),
        migrations.CreateModel(
            name='Notificacao',
